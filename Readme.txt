...
3. Run the command npm install in the app directory.
4. Run the program on your computer with npx expo start
5. Scan the qr code that your computer makes with the expo go app
