...
function Login({navigation}) {
    ...
    return (
        ...
        <View>
            <Image style={{width:250, height:200}} source={require('./fish.png')}/>
        </View>
        <View>
            <Text style = {{fontSize: 43, lineHeight: 60, color: 'white'}}>{"Log In"}</Text>
        </View>
        <View>
            <TextInput
            style={styles.input}
        ...
        <View style ={{marginBottom:40, flexDirection:'row', alignItems: 'center', justifyContent:"flex-start"}}>
